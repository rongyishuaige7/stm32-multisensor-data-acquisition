...
|:--|:--|:--|:--|
| `assets/photos/historical-prototype-overview.jpg` | 2026-05-02 | EXIF/GPS and other image metadata removed; resized from a copy | Historical data-acquisition prototype overview. |
| `assets/photos/historical-prototype-with-interface.jpg` | 2026-05-02 | EXIF/GPS and other image metadata removed; resized from a copy | Historical prototype and interface photo. |
